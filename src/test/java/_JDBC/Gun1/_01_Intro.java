...
public class _01_Intro {
    ...
    public void test1() throws SQLException {
       ...
       ResultSet rs=statement.executeQuery("select * from actor"); // sonuc olarak ResultSet verir. esitlersek
        ...
        String lastName=rs.getNString(3); // kolunun indexini de verebiliriz (1 ilk kolon)
